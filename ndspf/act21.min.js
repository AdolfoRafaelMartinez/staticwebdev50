...
var act={debounce:function(a,s){var i=null;return function(){var e=this,t=arguments;clearTimeout(i),i=setTimeout(function(){a.apply(e,t)},s)}},throttle:function(s,i,n){var o,r;return i=i||250,function(){var e=n||this,t=+new Date,a=arguments;o&&t<o+i?(clearTimeout(r),r=setTimeout(function(){o=t,s.apply(e,a)},i)):(o=t,s.apply(e,a))}},hex:function(e){return(e=e.match(/^rgba?[\s+]?\([\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?/i))&&4===e.length?"#"+("0"+parseInt(e[1],10).toString(16)).slice(-2)+("0"+parseInt(e[2],10).toString(16)).slice(-2)+("0"+parseInt(e[3],10).toString(16)).slice(-2):""}};jQuery.fn.extend({eqh:function(){function i(e,t){var a=0,s=0;e.css("min-height",e.outerHeight()),ResizeSensor.detach(t),t.addClass("no-transition").css("min-height","").each(function(e){var t=$(this).outerHeight();a<t&&(a=t,s=e)}),t.not(t.eq(s)).css("min-height",a),new ResizeSensor(t,act.debounce(function(){i(e,t)},10)),t.removeClass("no-transition"),e.css("min-height","")}this.each(function(){var t=$(this);if(t.is(".eqh-container")){var e=t.find(".eqh-item:not(.widget-type-custom_widget:has(.cm-col)), .eqh-item.widget-type-custom_widget .cm-col").filter(function(e){return $(this).closest(".eqh-container").is(t)});e&&(i(t,e),new ResizeSensor(e,act.debounce(function(){i(t,e)},10)))}})}}),jQuery(function(C){C(document);var b,m,v,i,a,w=C(window),y=C("html, body"),n=C("html"),o=C("body");window.location.hash&&(b=window.location.hash.replace(/^.*?(#|$)/,"")),o.prepend('<div class="media-md"></div><div class="media-sm"></div><div class="media-xs"></div><div class="theme-color bg-theme"></div>'),C(".media-md").eq(0).each(function(){var e=C(this),t=e.width();o.attr("data-media-md",t),m=t,e.remove()}),C(".media-sm").eq(0).each(function(){var e=C(this),t=e.width();o.attr("data-media-sm",t),v=t,e.remove()}),C(".media-xs").eq(0).each(function(){var e=C(this),t=e.width();o.attr("data-media-xs",t),i=t,e.remove()}),C(".theme-color").eq(0).each(function(){var e=C(this),t=act.hex(e.css("background-color"));o.attr("data-theme-color",t),a=t,e.remove()}),o.fitVids({ignore:".hs-responsive-embed-inner-wrapper"}),C(".fluid-width-video-wrapper").parent(".hs-responsive-embed").removeClass("hs-responsive-embed hs-responsive-embed-youtube hs-responsive-embed-vimeo"),C(".cta_button.button").initialize(function(){C(this).removeAttr("title")}),C(".eqh-container").eqh(),C(".menu-bar li.hs-item-has-children").each(function(){var e=C(this);0==e.find("ul").length&&e.removeClass("hs-item-has-children")}),C(".accordion-menu .hs-menu-wrapper li.hs-item-has-children ul").each(function(){C(this).closest("li").append('<span class="expand-level"></span>')}),C('.accordion-menu .expand-level, .accordion-menu li:has(.expand-level) > a[href="javascript:;"]').on("click",function(){var e=C(this).closest("li");e.closest("li");e.hasClass("expanded")?e.removeClass("expanded").find("ul").addClass("hidden").find(".expanded").removeClass("expanded"):e.addClass("expanded").find("> ul").removeClass("hidden"),e.siblings().removeClass("expanded").find("ul").addClass("hidden").find("li.expanded").removeClass("expanded")}),C("[data-reveal]").each(function(){var e=C(this),t=C("#"+e.attr("data-reveal"));e.on("click",function(){return e.toggleClass("on"),t.toggleClass("on"),!1})}),C("[data-slide-menu]").each(function(){var e=C(this),t=e.attr("data-slide-menu"),a=C('[data-slide-menu="'+t+'"]').not(this),s=C("#"+t),i=s.closest(".row-fluid-wrapper").next(".row-fluid-wrapper").find(".slide-menu-overlay");e.on("click",function(){e.toggleClass("on"),s.toggleClass("on"),a.toggleClass("on"),i.toggleClass("on"),s.hasClass("on")?o.addClass("noscroll"):o.removeClass("noscroll"),C("[data-slide-menu]").not(this).not(a).removeClass("on"),C(".slide-menu").not(s).removeClass("on"),C(".slide-menu-overlay").not(i).removeClass("on")}),i.on("click",function(){e.removeClass("on"),s.removeClass("on"),a.removeClass("on"),i.removeClass("on"),o.removeClass("noscroll")})}),C('.slide-menu a[href^="#"], .slide-menu a[href^="/#"]').on("click",function(){C("[data-slide-menu], .slide-menu, .slide-menu-overlay").removeClass("on"),o.removeClass("noscroll")}),C(".sticky-header").each(function(){var t=C(this),e=t.closest(".sticky-header-options"),a=C(e.attr("data-linked-to"));0<a.length?w.on("load resize scroll",act.throttle(function(){var e=w.scrollTop();a.height()+a.offset().top<e?(t.addClass("on"),a.addClass("off")):(t.removeClass("on"),a.removeClass("off"))},10)):t.addClass("on")}),C(".hs-item-has-children:not(:has(ul))").removeClass("hs-item-has-children"),C(".map-section").append('<div class="map-overlay" />'),C(".map-overlay").on("click",function(){C(this).css("pointer-events","none")}),C('[class*="scroll-next-"]').each(function(){var e=C(this);0<e.closest(".row-fluid-wrapper").next(".row-fluid-wrapper").find(".content-section, .hero-slider, .hero-banner").length&&(e.hasClass("scroll-offset-sticky-header")?e.append('<a class="sn-arrow sn-offset-sticky-header" href="#"><i class="fa fa-chevron-down"></i></a>'):e.append('<a class="sn-arrow" href="#"><i class="fa fa-chevron-down"></i></a>'))}),C(".sn-arrow").on("click",function(){var e=C(this).closest(".row-fluid-wrapper").next(".row-fluid-wrapper").find(".content-section, .hero-slider, .hero-banner").offset().top,t=0;return C(this).hasClass("sn-offset-sticky-header")&&0<C(".sticky-header").length&&(t=C(".sticky-header").height()-1),y.animate({scrollTop:e-t},300,"easeOutExpo"),!1}),o.prepend('<a name="top"></a>').append('<span class="scroll-to-top"><i class="fa fa-chevron-up"></i></span>');var e=C(".scroll-to-top");e.on("click",function(){y.animate({scrollTop:0},300,"easeOutExpo")}),w.on("load scroll",act.throttle(function(){95<w.scrollTop()?e.addClass("active"):e.removeClass("active")},250)),0==C("html.lt-ie9").length&&C("a[href*=\\#]:not([href=\\#], .popup-content, .tabs-nav a, .advanced-gallery-link)").on("click",function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var e=C(this.hash);if((e=e.length?e:C('[name="'+this.hash.slice(1)+'"]')).length){var t=e.offset().top,a=0;return e.is('[class*="offset-"]')&&(a=parseInt(e.attr("class").match(/offset-\d+/)[0].replace("offset-",""))),"top"==e.attr("name")&&(t=0),y.animate({scrollTop:t-a},300,"easeOutExpo"),!1}}}),C(".accordion-header").on("click",function(){var e=C(this).closest(".accordion-item"),t=e.attr("data-accordion-group");e.toggleClass("collapsed"),""!=t&&C('.accordion-item[data-accordion-group="'+t+'"]').not(C(this).closest(".accordion-item")).addClass("collapsed")});var t=C("body").find('.accordion-item[data-accordion-anchor="'+b+'"]').first();0<t.length&&(t.removeClass("collapsed"),C('.accordion-item[data-accordion-group="'+t.attr("data-accordion-group")+'"]').not(t.closest(".accordion-item")).addClass("collapsed"),y.animate({scrollTop:t.offset().top-100},300,"easeOutExpo")),C(".tabs-container").each(function(){var s=C(this);if(s.find('.tabs-nav a[href^="#"]').each(function(){var e=C(this),t=e.attr("href"),a=s.find(".tab-group"+t).eq(0);0<a.length&&(s.is(".responsive")||s.is(".md-responsive")?(e.addClass("tab-link").clone().addClass("mirror").prependTo(a.closest(".row-fluid-wrapper")),e.closest("li").addClass("duplicate")):e.addClass("tab-link"))}),0==s.find(".tab-group.active").length){var e=s.find(".tab-group").eq(0);e.addClass("active"),C('.tab-link[href="#'+e.attr("id")+'"]').addClass("active")}else C('.tab-link[href="#'+s.find(".tab-group.active").eq(0).attr("id")+'"]').addClass("active");s.find(".tab-link").on("click",function(){var e=C(this),t=s.find(".tab-group"+e.attr("href"));if(0<t.length){if(s.find(".tab-group").removeClass("active"),s.find(".tab-link").removeClass("active"),t.addClass("active"),s.find('.tab-link[href="'+e.attr("href")+'"]').addClass("active"),e.hasClass("mirror")){var a=e.offset().top;y.animate({scrollTop:a-50},300,"easeOutExpo")}w.trigger("scroll"),w.trigger("tabChanged"),t.find(".slider-container").nboslick("refresh"),t.is(".eqh-container")&&t.eqh(),t.find(".eqh-container").eqh(),C.force_appear()}return!1})});var s=C("body").find('.tab-group[id="'+b+'"]').first(),r=s.closest(".tabs-container");if(0<s.length){r.find(".tab-group").removeClass("active"),s.addClass("active"),r.find(".tab-link").removeClass("active"),r.find(".tab-link[href=#"+b+"]").addClass("active");var l=s.offset().top,c=0<C(".sticky-header").length?C(".sticky-header").height():0;y.animate({scrollTop:l-c-30},300,"easeOutExpo")}C(".read-more-button-expand").on("click",function(){return C(this).closest(".read-more").removeClass("collapsed"),!1}),C(".read-more-button-collapse").on("click",function(){var e=C(this).closest(".read-more"),t=e.offset().top;return e.addClass("collapsed"),y.animate({scrollTop:t-100},300,"easeOutExpo"),!1}),C(".content-section .bg-img").each(function(){var e=C(this),t=e.closest(".content-section"),a=e.find("img").eq(0);if(0<a.length){var s=a.attr("src"),i=a.attr("alt");e.hasClass("bg-parallax")?(t.attr("data-parallax","scroll").attr("data-image-src",s).attr("data-image-alt",i||"").parallax({iosFix:!0,bleed:200}),new ResizeSensor(t,function(){t.trigger("resize.px.parallax")})):t.css("background-image","url('"+s+"')").addClass("bg-img-defined")}}),C(".hero-banner .video-url, .content-section .video-url").each(function(){var e=C(this),t=e.closest(".hero-banner, .content-section"),a=e.text().trim();if(""!=a){if(0<e.closest(".md-no-video-bg").length&&w.width()<=m)return;if(0<e.closest(".sm-no-video-bg").length&&w.width()<=v)return;if(0<e.closest(".xs-no-video-bg").length&&w.width()<=i)return;t.addClass("video-bg").prepend('<div class="video-object"><video autoplay playsinline muted loop src="'+a+'"></video></div>')}});var d=C(".fullscreen-search"),h=d.find(".hs-input");function p(e){var t=e,a=t.closest(".sticky-parent"),s=t.is('[class*="offset-"]')?parseInt(t.attr("class").match(/offset-\d+/)[0].replace("offset-","")):0,i=t.parent(".sticky-item-wrapper"),n=i.prev(".sticky-item-ref"),o=w.scrollTop(),r=w.width(),l=t.outerHeight(!0),c=a.outerHeight(),d=parseInt(a.css("padding-bottom"))+parseInt(a.css("border-bottom-width")),h=a.offset().top,p=n.offset().top,f=n.offset().left,u=n.width();r<=m&&t.hasClass("md-cancel")||r<=v&&!t.hasClass("no-cancel")?(i.removeAttr("style"),n.css("height",0)):p-s<=o?(o<h+c-d-l-s?i.css({position:"fixed",left:f,top:s,bottom:"auto",width:u}).removeClass("flat"):i.css({position:"absolute",left:f,top:"auto",bottom:d,width:u}).addClass("flat"),n.css("height",l)):(i.removeAttr("style").removeClass("flat"),n.css("height",0))}d.each(function(){n.addClass("fss-on"),d.appendTo(o),d.find("form").before('<div class="fss-overlay"/>'),0<d.find(".hs-form label").length&&h.attr("placeholder",d.find(".hs-form label").text()),d.find(".hs-form label").remove(),d.find(".hs-button").html('<i class="fa fa-search"></i>'),d.hasClass("with-close")&&d.append('<a class="fss-close-btn" href="#"><i class="fa fa-times"></i></a>'),C(".fss-open-btn").on("click",function(){return n.addClass("fullscreen-search-open"),/iPad|iPhone|iPod/g.test(navigator.userAgent)||setTimeout(function(){h.focus()},250),!1}),C(".fss-close-btn").on("click",function(){return n.removeClass("fullscreen-search-open"),!1}),C(".fullscreen-search:not(.with-close.only-close)").find(".fss-overlay").on("click",function(){n.removeClass("fullscreen-search-open")})}),C(".rss-cards .hs-rss-item").initialize(function(){var e=C(this),t=e.closest(".rss-cards"),a=t.find(".hs-rss-module").eq(0);if(t.hasClass("equal-height")&&e.find(".hs-rss-description a").eq(0).wrap('<div class="rss-more" />'),t.hasClass("full-links")&&e.append('<a class="full-link" href="'+e.find("a.hs-rss-title").attr("href")+'"></a>'),e.html('<div class="rss-card">'+e.html()+"</div>"),!t.hasClass("no-masonry")&&!t.hasClass("one-column")){var s=a.isotope({itemSelector:".hs-rss-item",isFitWidth:!0});a.imagesLoaded(function(){s.isotope()}),s.one("arrangeComplete",function(){t.addClass("done")})}}),C(".listing-container.multi-filter").each(function(){if(b)var a=b.split(",");var r=C(this),l=r.find(".listing-pagination"),c=r.find(".listing-menu"),e=r.find(".listing-pagination-options"),i=r.find(".listing-search input"),d=10,h=1,p={},f="data-filter",u="data-page",t={percentPosition:!0,layoutMode:"masonry"};r.hasClass("no-masonry")&&(Isotope.Item.prototype._create=function(){this.id=this.layout.itemGUID++,this._transn={ingProperties:{},clean:{},onEnd:{}},this.sortData={}},Isotope.Item.prototype.layoutPosition=function(){this.emitEvent("layout",[this])},Isotope.prototype.arrange=function(e){this.option(e),this._getIsInstant(),this.filteredItems=this._filter(this.items),this._isLayoutInited=!0},Isotope.LayoutMode.create("none"),t.layoutMode="none");var s=r.find(".listing-items > .hs_cos_wrapper_type_widget_container");if(0<s.length){(v=s).find("> .hs_cos_wrapper").addClass("listing-cell");var m=".listing-cell";v.find(".listing-filter").each(function(){var e=C(this);e.closest(".listing-cell").attr("data-filter",e.attr("data-filter"))})}else{var v;(v=r.find(".listing-items")).addClass("drag"),v.find(".listing-item").closest(".row-fluid-wrapper").addClass("listing-cell"),C(m=".row-fluid-wrapper.listing-cell").each(function(){var e=C(this).find(".listing-filter").first();C(this).attr("data-filter",e.attr("data-filter").replace(" ","").replace(","," "))})}function g(e){var t,a,s=m;for(t=0;t<c.length;t++)"*"!=p[t]&&(s+="["+f+'*="'+p[t]+'"]');s+="["+u+'="'+e+'"]',a=s+=":not(.search-ignored)",v.isotope({filter:a})}function n(){var e=v.children(m).not(".search-ignored").length,t=(Math.ceil(e/d),1),a=1,s=m;for(i=0;i<c.length;i++)"*"!=p[i]&&(s+="["+f+'*="'+p[i]+'"]');v.children(s).not(".search-ignored").each(function(){d<t&&(a++,t=1),C(this).attr(u,a),t++}),h=a,l.html("");for(var i=0;i<h;i++){if(0==i)var n="active";else n="";var o=C('<a href="javascript:;" class="listing-page-number '+n+'" '+u+'="'+(i+1)+'"></a>');o.html(i+1),o.on("click",function(){var e=C(this),t=e.attr(u);e.siblings().removeClass("active"),e.addClass("active"),g(t);var a=r.find(".scroll-here-from-pagination").eq(0);if(0<a.length){var s=a.is('[class*="offset-"]')?parseInt(a.attr("class").match(/offset-\d+/)[0].replace("offset-","")):0;y.animate({scrollTop:a.offset().top-s},500,"easeOutExpo")}}),1<h?o.appendTo(l):l.html("")}}t.itemSelector=m,""!=e.attr("data-items-per-page")&&(d=e.attr("data-items-per-page")),c.each(function(s){var e=C(this);b&&a[s]&&"all"!=a[s]&&e.find('a[href="#'+a[s]+'"]').addClass("active");var t=e.find("a.active").eq(0);0==t.length?(e.find('a[href="#all"], a[href="#All"]').addClass("active"),p[s]="*"):p[s]=t.attr("href").replace("#",""),e.find('a[href^="#"]').on("click",function(){var e=C(this);"#all"==e.attr("href").toLowerCase()?p[s]="*":p[s]=e.attr("href").replace("#",""),e.closest("li").siblings().find("a").removeClass("active"),e.addClass("active"),r.find(m).removeClass("search-ignored"),i.val("");var t=r.find(".scroll-here-from-menu").eq(0);if(0<t.length){var a=t.is('[class*="offset-"]')?parseInt(t.attr("class").match(/offset-\d+/)[0].replace("offset-","")):0;y.animate({scrollTop:t.offset().top-a},500,"easeOutExpo")}return n(),g(1),!1})}),v.isotope(t),new ResizeSensor(C(m),function(){v.isotope(t)}),v.imagesLoaded(function(){v.isotope()}),w.load(function(){v.isotope(),r.addClass("done")}),n(),g(1),i.on("keyup",act.debounce(function(){var e=i.val(),t=new RegExp(e,"gi");if(""==e)r.find(m).removeClass("search-ignored"),n(),g(1);else{r.find(m).addClass("search-ignored"),v.isotope({filter:function(){return!t||C(this).text().match(t)}});var a=v.isotope("getFilteredItemElements");C.each(a,function(){C(this).removeClass("search-ignored")}),n(),g(1)}},250))}),C(".listing-container:not(.multi-filter)").each(function(){var r=C(this),l=r.find(".listing-pagination"),i=r.find(".listing-menu"),e=r.find(".listing-pagination-options"),n=r.find(".listing-search input"),c=10,d=1,h="*",p="data-filter",f="data-page",t={percentPosition:!0,layoutMode:"masonry"};i.find("a.active").first().each(function(){h=C(this).attr("href").replace("#","")}),r.hasClass("no-masonry")&&(Isotope.Item.prototype._create=function(){this.id=this.layout.itemGUID++,this._transn={ingProperties:{},clean:{},onEnd:{}},this.sortData={}},Isotope.Item.prototype.layoutPosition=function(){this.emitEvent("layout",[this])},Isotope.prototype.arrange=function(e){this.option(e),this._getIsInstant(),this.filteredItems=this._filter(this.items),this._isLayoutInited=!0},Isotope.LayoutMode.create("none"),t.layoutMode="none");var a=r.find(".listing-items > .hs_cos_wrapper_type_widget_container");if(0<a.length){(m=a).find("> .hs_cos_wrapper").addClass("listing-cell");var u=".listing-cell";m.find(".listing-filter").each(function(){var e=C(this);e.closest(".listing-cell").attr("data-filter",e.attr("data-filter"))})}else{var m;(m=r.find(".listing-items")).addClass("drag"),m.find(".listing-item").closest(".row-fluid-wrapper").addClass("listing-cell"),C(u=".row-fluid-wrapper.listing-cell").each(function(){var e=C(this).find(".listing-filter").first();C(this).attr("data-filter",e.attr("data-filter").replace(" ","").replace(","," "))})}function v(e){var t,a=u;"*"!=h&&(a+="["+p+'*="'+h+'"]'),a+="["+f+'="'+e+'"]',t=a+=":not(.search-ignored)",m.isotope({filter:t})}function o(){var e=m.children(u).not(".search-ignored").length,t=(Math.ceil(e/c),1),a=1,s=u;"*"!=h&&(s+="["+p+'*="'+h+'"]'),m.children(s).not(".search-ignored").each(function(){c<t&&(a++,t=1),C(this).attr(f,a),t++}),d=a,l.html("");for(var i=0;i<d;i++){if(0==i)var n="active";else n="";var o=C('<a href="javascript:;" class="listing-page-number '+n+'" '+f+'="'+(i+1)+'"></a>');o.html(i+1),o.on("click",function(){var e=C(this),t=e.attr(f);e.siblings().removeClass("active"),e.addClass("active"),v(t);var a=r.find(".scroll-here-from-pagination").eq(0);if(0<a.length){var s=a.is('[class*="offset-"]')?parseInt(a.attr("class").match(/offset-\d+/)[0].replace("offset-","")):0;y.animate({scrollTop:a.offset().top-s},500,"easeOutExpo")}}),1<d?o.appendTo(l):l.html("")}}t.itemSelector=u,""!=e.attr("data-items-per-page")&&(c=e.attr("data-items-per-page")),i.each(function(){var e=C(this);0==e.find("a.active").eq(0).length&&e.find('a[href="#all"], a[href="#All"]').addClass("active")}),m.isotope(t),new ResizeSensor(C(u),function(){m.isotope(t)}),i.find('a[href^="#"]').on("click",function(){var e,t=C(this);e="#all"==t.attr("href").toLowerCase()?"*":t.attr("href").replace("#",""),t.closest("li").siblings().find("a").removeClass("active"),t.addClass("active"),h=e,r.find(u).removeClass("search-ignored"),n.val("");var a=r.find(".scroll-here-from-menu").eq(0);if(0<a.length){var s=a.is('[class*="offset-"]')?parseInt(a.attr("class").match(/offset-\d+/)[0].replace("offset-","")):0;y.animate({scrollTop:a.offset().top-s},500,"easeOutExpo")}return o(),v(1),!1}),i.find('a[href="#'+b+'"]').first().each(function(){var e,t=C(this);if(0<t.length)return e="all"==b.toLowerCase()?"*":b,i.find("a").removeClass("active"),t.addClass("active"),h=e,o(),v(1),!1}),m.imagesLoaded(function(){m.isotope()}),w.load(function(){m.isotope(),r.addClass("done")}),o(),v(1),n.on("keyup",act.debounce(function(){var e=n.val(),t=new RegExp(e,"gi");if(""==e){var a=i.find("a.active").eq(0);h="#all"==a.attr("href").toLowerCase()?"*":a.attr("href").replace("#",""),r.find(u).removeClass("search-ignored"),o(),v(1)}else{r.find(u).addClass("search-ignored"),m.isotope({filter:function(){return!t||C(this).text().match(t)}});var s=m.isotope("getFilteredItemElements");C.each(s,function(){C(this).removeClass("search-ignored")}),o(),v(1)}},250))}),C(".hero-slider .slick-slide").css("background-image",function(){var e=C(this).find("img");return e.attr("data-lazy")?"url('"+e.attr("data-lazy")+"')":"url('"+e.attr("src")+"')"}),-1!==navigator.appVersion.indexOf("MSIE 10")||window.MSInputMethodContext&&document.documentMode||!Modernizr.csscalc||!Modernizr.cssvhunit?w.on("load resize",act.debounce(function(){var s=C(".header-wrapper").height(),i=w.height();C(".hero-slider.full-vh").each(function(){var e=C(this),t=e.find(".slick-track"),a=(t.height(),0);t.css({height:"auto","min-height":0}),e.hasClass("minus-header")&&(i-=s),e.find(".slick-slide").each(function(){var e=C(this).height();a<e&&(a=e)}),a<i?t.height(i):t.height(a)}).css("min-height",0).addClass("done")},250)):w.on("load resize",act.debounce(function(){var e=C(".header-wrapper").height();C(".hero-slider.full-vh.minus-header .slick-track").css("min-height",function(){return"calc(100vh - "+e+"px)"}).closest(".hero-slider").css("min-height",0).addClass("done")},250)),C("a.popup-image, .popup-image a").nboMagnificPopup({type:"image",mainClass:"nbomfp-fade",tClose:"",closeMarkup:'<div class="popup-close"></div>'}),C("a.popup-iframe, .popup-iframe a").each(function(){var e=C(this).hasClass("enable-on-mobile")||C(this).closest(".popup-iframe").hasClass("enable-on-mobile");C(this).nboMagnificPopup({type:"iframe",disableOn:function(){return!(w.width()<=v)||!!e},mainClass:"nbomfp-fade",tClose:"",closeMarkup:'<div class="popup-close"></div>',removalDelay:160,preloader:!1,fixedContentPos:!1})}),C("a.popup-content, .popup-content a").nboMagnificPopup({type:"inline",mainClass:"nbomfp-fade",tClose:"",closeMarkup:'<div class="popup-close"></div>',removalDelay:100,callbacks:{open:function(){C.force_appear(),w.trigger("resize")}}}),C(".popup-image a:not([title])").each(function(){var e=C(this),t=e.find("img").eq(0).attr("title");""!=t&&e.attr("title",t)}),C('.advanced-gallery img:not(".change-image img")').each(function(){var e=C(this),t=(e.closest(".advanced-gallery"),e.attr("src")),a=e.attr("title");0==e.closest("a").length&&e.wrap('<a href="'+t+'"></a>');var s=e.closest("a");""!=a&&(s.attr("data-title",a),e.removeAttr("title")),e.is(".video img")&&s.addClass("video")}),C(".advanced-gallery").each(function(){C(this).find("a:not(.external-link a)").nboMagnificPopup({type:"image",mainClass:"nbomfp-fade",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1],tPrev:"",tNext:""},iframe:{patterns:{youtube:{src:"//www.youtube.com/embed/%id%?autoplay=1&amp;rel=0"}}},image:{tError:'<a href="%url%">The image #%curr%</a> could not be loaded.',titleSrc:function(e){return e.el.attr("data-title")}},tClose:"",closeMarkup:'<div class="popup-close"></div>',callbacks:{elementParse:function(e){"video"==e.el.context.className?e.type="iframe":e.type="image"}}})}),C(".advanced-gallery-link").on("click",function(e){e.preventDefault(),C(C(this).attr("href")+" a:not(.external-link a)").first().nboMagnificPopup("open")}),C(".popup-target").each(function(){var e=C(this).attr("id");e==b&&C.nboMagnificPopup.open({items:{src:"#"+e,type:"inline"},tClose:"",closeMarkup:'<div class="popup-close"></div>'})}),C(".popup-group").each(function(){C(this).find("a:not(.external-link a)").nboMagnificPopup({type:"inline",tLoading:"Loading...",mainClass:"nbomfp-fade",gallery:{enabled:!0,tPrev:"",tNext:""},tClose:"",closeMarkup:'<div class="popup-close"></div>'})}),-1!==navigator.appVersion.indexOf("MSIE 10")&&n.addClass("is-ie10"),window.MSInputMethodContext&&document.documentMode&&n.addClass("is-ie11"),C(".form-box").each(function(){var e=C(this);0==e.find(".form-box-header").length&&e.addClass("no-title")}),new WOW({boxClass:"reveal"}).init(),C(".slick-slide .caption.superimpose").closest(".hs_cos_gallery_main").addClass("with-superimposed-caption"),C(".slider-container").each(function(){var a=C(this),e={},t=767;if(a.is(".widget-type-widget_container"))var s=C("> .hs_cos_wrapper_widget_container",a);else s=a;e.adaptiveHeight=!!a.hasClass("adaptive-height"),e.variableWidth=!!a.hasClass("variable-width"),e.autoplay=!!a.hasClass("autoplay"),e.autoplaySpeed=a.is('[class*="autoplay-speed-"]')?parseInt(a.attr("class").match(/autoplay-speed-\d+/)[0].replace("autoplay-speed-","")):3e3,e.speed=a.is('[class*="animation-speed-"]')?parseInt(a.attr("class").match(/animation-speed-\d+/)[0].replace("animation-speed-","")):300,e.arrows=!!a.hasClass("arrows"),e.dots=!!a.hasClass("dots"),e.fade=!!a.hasClass("fade"),e.centerMode=!!a.hasClass("center-mode"),e.centerPadding=a.is('[class*="center-padding-"]')?a.attr("class").match(/center-padding-\d+/)[0].replace("center-padding-","")+"px":"50px",e.infinite=!!a.hasClass("infinite"),e.pauseOnHover=!!a.hasClass("pause-on-hover"),e.slidesToShow=a.is('[class*="slides-to-show-"]')?parseInt(a.attr("class").match(/slides-to-show-\d+/)[0].replace("slides-to-show-","")):1,e.slidesToScroll=a.is('[class*="slides-to-scroll-"]')?parseInt(a.attr("class").match(/slides-to-scroll-\d+/)[0].replace("slides-to-scroll-","")):1,e.vertical=!!a.hasClass("vertical"),e.verticalSwiping=!!a.hasClass("vertical-swiping"),e.draggable=!n.hasClass("hs-inline-edit")&&!a.hasClass("not-draggable"),e.swipe=!a.hasClass("not-swipeable"),a.hasClass("md-stack")?t=m:a.hasClass("sm-stack")?t=v:a.hasClass("xs-stack")&&(t=i),e.responsive=[{breakpoint:t,settings:{arrows:!0,centerMode:!1,centerPadding:"0",slidesToShow:1}}],s.on("init",function(e,t){w.trigger("resize.px.parallax"),C.force_appear(),a.eqh(),a.find(".eqh-container").eqh(),w.trigger("sliderContainerInit")}),s.on("afterChange",function(e,t){w.trigger("resize.px.parallax"),C.force_appear(),a.eqh(),a.find(".eqh-container").eqh(),w.trigger("sliderContainerChanged")}),s.nboslick(e)}),C(".hero-slider-v2 .eqh-item").addClass("eqh-never-cancel"),0<C(".header-overlap").eq(0).length&&o.addClass("header-overlap"),C(".full-vh.minus-header").each(function(){var t=C(this);w.on("load resize sliderContainerInit sliderContainerChanged",act.debounce(function(){var e=C(".header-wrapper").height();t.css("min-height",function(){return"calc(100vh - "+e+"px)"}),w.trigger("resize.px.parallax"),t.addClass("done")},250))}),C(".sticky-item").each(function(){var e=C(this);e.wrap('<div class="sticky-item-wrapper" />'),e.parent(".sticky-item-wrapper").before('<div class="sticky-item-ref" style="height: 0;" />'),w.on("load scroll resize tabChanged",function(){p(e)}),new ResizeSensor(e,function(){p(e)}),new ResizeSensor(e.parent(".sticky-item-wrapper").prev(".sticky-item-ref"),function(){p(e)}),new ResizeSensor(e.closest(".sticky-parent"),function(){p(e)})}),C(".mega-menu-branch").each(function(){var t=C(this),a=t.closest(".mega-menu-parent"),e=t.closest(".mega-menu-options"),s=t.closest(".mega-menu").find(".mega-menu-branch").not(this),i=C(e.attr("data-menu"));if(0<i.length&&t.is('[class*="activated-by-"]')){var n=parseInt(t.attr("class").match(/activated-by-\d+/)[0].replace("activated-by-","")),o=i.find(".hs-menu-wrapper > ul > li").eq(n-1),r=o.siblings(),l=e.attr("data-parent-active-class")?e.attr("data-parent-active-class"):"";o.addClass("mega-menuized"),o.on("mouseenter",act.debounce(function(){s.removeClass("active"),t.addClass("active"),r.removeClass("mega-menuized-active"),o.addClass("mega-menuized-active"),a.addClass(l)},200)).on("mouseleave",act.debounce(function(e){t.is(":hover")||(t.removeClass("active"),o.removeClass("mega-menuized-active"),a.removeClass(l))},200)),t.on("mouseleave",act.debounce(function(){o.each(function(){C(this).is(":hover")||(t.removeClass("active"),o.removeClass("mega-menuized-active"),a.removeClass(l))})},200)),w.on("resize scroll",act.debounce(function(){t.removeClass("active"),o.removeClass("mega-menuized-active"),a.removeClass(l)},50))}});var f=C(".hs-menu-wrapper"),u=f.find("> ul > li"),g=(f.find("> ul > li > a"),C(C(".page-section").get().reverse())),k={},x=[];f.find('a[href^="http://#"], a[href^="https://#"]').each(function(){var e=C(this),t=e.attr("href").replace("http://#","#").replace("https://#","#");e.attr("href",t)}),g.each(function(){var e=C(this).attr("id");k[e]=f.find("> ul > li > a[href=#"+e+"]"),C(this).is('[class*="active-offset-"]')?x[e]=parseInt(C(this).attr("class").match(/active-offset-\d+/)[0].replace("active-offset-",""))+1:x[e]=200}),w.on("load scroll resize",act.throttle(function(){var i=w.scrollTop();g.each(function(){var e=C(this),t=e.offset().top,a=e.attr("id"),s=k[a].closest("li");if(i>=t-x[a])return s.hasClass("active")||(u.removeClass("active"),s.addClass("active")),!1;s.removeClass("active")})},100)),C(".circle-loader").appear({force_process:!0}).on("appear",function(){var n=C(this),o=n.closest(".circle-loader-wrapper"),e=a,t=a;n.attr("data-color-1")&&(e=n.attr("data-color-1")),n.attr("data-color-2")&&(t=n.attr("data-color-2")),n.data("inited")||(n.on("circle-animation-start",function(e){o.addClass("started")}).circleProgress({size:400,fill:{gradient:[e,t]}}).on("circle-animation-progress",function(e,t,a){var s=n.find(".number");if(n.is("[data-custom-number]")){var i=n.attr("data-custom-number");o.hasClass("v2")?s.html(Math.round(t*i)):s.html(Math.round(a*i))}else n.is("[data-custom-text]")?s.html(n.attr("data-custom-text")):s.html(Math.round(100*a)+'<span class="percent">%</span>')}).on("circle-animation-end",function(e){o.addClass("done")}),n.data("inited",!0))}),C(".bar-loader").appear({force_process:!0}).on("appear",function(){var e=C(this);e.addClass("started").find(".number").one("webkitAnimationEnd oanimationend msAnimationEnd animationend",function(){e.addClass("done")})}),o.append('<div class="tooltipster-base" />'),C(".tooltip:not(.hs-inline-edit .tooltip)").initialize(function(){var e=C(this),t="top",a="theme",s="hover",i=300;if(e.attr("data-tooltip-direction")&&(t=e.attr("data-tooltip-direction")),e.attr("data-tooltip-color")&&(a=e.attr("data-tooltip-color")),e.attr("data-tooltip-trigger")&&(s=e.attr("data-tooltip-trigger")),e.attr("data-tooltip-maxwidth")&&(i=e.attr("data-tooltip-maxwidth")),e.is(".cta_button .tooltip")){var n=e.attr("title");e.removeAttr("title"),(e=e.closest(".cta_button")).attr("title",n)}else if(e.is(".tooltip.on-parent")){n=e.attr("title");e.removeAttr("title"),(e=e.parent()).attr("title",n)}e.tooltipster({delay:1,maxWidth:i,speed:10,interactive:!0,theme:a,side:t,contentCloning:!0,contentAsHTML:!0,distance:15,trigger:s})}),C(".countdown-timer").each(function(){var t=C(this),e=parseInt(t.attr("data-cd-year")),a=parseInt(t.attr("data-cd-month")),s=parseInt(t.attr("data-cd-day")),i=parseInt(t.attr("data-cd-hour")),n=t.attr("data-cd-minute"),o=t.attr("data-cd-label-days"),r=t.attr("data-cd-label-hours"),l=t.attr("data-cd-label-minutes"),c=t.attr("data-cd-label-seconds"),d=new Date(Date.UTC(e,a-1,s,i,n,0,0));t.countdown(d,function(e){t.find(".time").eq(0).html(e.strftime('<span class="segment days"><span class="number">%D</span><span class="label">'+o+'</span></span></span><span class="sep"></span><span class="segment hours"><span class="number">%H</span><span class="label">'+r+'</span></span></span><span class="sep"></span><span class="segment minutes"><span class="number">%M</span><span class="label">'+l+'</span></span></span><span class="sep"></span><span class="segment seconds"><span class="number">%S</span><span class="label">'+c+"</span></span></span>"))})}),plyr.setup(".media-player",{iconUrl:"https://cdn2.hubspot.net/hubfs/273774/mp/themes/Act-Theme/images/plyr.svg",blankUrl:"https://cdn2.hubspot.net/hubfs/273774/mp/themes/Act-Theme/videos/plyr.mp4",controls:["play-large","play","progress","current-time","mute","volume","fullscreen"]}),C(".content-card-image img").closest(".content-card").addClass("with-image"),C(".content-card-link a").closest(".content-card").addClass("with-link"),C(".dated-titles-container").each(function(){var e=C(this);e.find(".dated-title").each(function(){var e=C(this);e.closest(".hs_cos_wrapper").css("order",e.attr("data-dt-order"))}),e.addClass("done")}),C(".one-field-form .hs-input").initialize(function(){var e=C(this),t=e.closest(".hs-form").find(".hs-button").eq(0).outerWidth();e.css("padding-right",t+20)}),w.load(function(){C(".list-type-dropdown").not(".plain-links").each(function(){var t=C(this),e=t.find("ul").eq(0),a=t.find("a"),s=e.find("a.active").eq(0);e.before('<div class="control fade-in">'+s.html()+"</div>");var i=t.find(".control").eq(0);i.click(function(){t.toggleClass("open")}),a.click(function(){i.html(C(this).html()),t.removeClass("open")}),n.click(function(e){C(e.target).is(t)||C(e.target).is(i)||t.removeClass("open")})}),C(".list-type-dropdown.plain-links").each(function(){var t=C(this),e=t.find("h1, h2, h3, h4").eq(0),a=t.find("ul").eq(0),s=t.find("a");a.before('<div class="control fade-in">'+e.html()+"</div>");var i=t.find(".control").eq(0);i.click(function(){t.toggleClass("open")}),n.click(function(e){C(e.target).is(s)||C(e.target).is(i)||t.removeClass("open")})})}),C("#blog-listing-more").click(function(){var s=C(this),e=s.attr("href"),i=C("#blog-listing-container");return C.ajax({url:e,type:"GET",success:function(e){var t=(e=C(e)).find("#blog-listing-container").html(),a=e.find("#blog-listing-more").attr("href");i.append('<div class="blog-listing-new-row fade-in">'+t+"</div>"),a?s.attr("href",a):s.remove()},complete:function(e){setTimeout(function(){i.find(".eqh-container").eqh()},200)}}),!1}),C('[class*="wrapper-class--"]').each(function(){var t=C(this),e=t.attr("class").split(" ");C.each(e,function(){var e=this.match(/wrapper-class--[\s\S]*/);e&&t.closest(".row-fluid-wrapper").addClass(e.toString().replace("wrapper-class--",""))})}),C('[class*="row-class--"]').each(function(){var t=C(this),e=t.attr("class").split(" ");C.each(e,function(){var e=this.match(/row-class--[\s\S]*/);e&&t.closest(".row-fluid").addClass(e.toString().replace("row-class--",""))})}),C('[class*="form-button-class--"] .hs-button').initialize(function(){var t=C(this),e=t.closest('[class*="form-button-class--"]').attr("class").split(" ");C.each(e,function(){var e=this.match(/form-button-class--[\s\S]*/);e&&t.addClass(e.toString().replace("form-button-class--",""))})}),C('[class*="form-title-class--"]').each(function(){var t=C(this),e=t.attr("class").split(" ");C.each(e,function(){var e=this.match(/form-title-class--[\s\S]*/);e&&t.find(".form-title").addClass(e.toString().replace("form-title-class--",""))})}),C(".random-content").each(function(){var e=C(this).find("> *");e.eq(Math.floor(Math.random()*e.length)).addClass("fade-in").show()}),C("body").on("click",".lang-select .globe_class",function(){var t=C(this);t.find("a");C(this).toggleClass("open"),n.click(function(e){C(e.target).is(t)||t.removeClass("open")}),w.on("scroll",function(){t.removeClass("open")})}),C(".lang-select a.current_lang").initialize(function(){var e=C(this).parent();e.prependTo(e.parent())}),C(".hs-inline-edit .widget-type-raw_jinja").removeAttr("data-widget-type"),C(".slide-menu .control-button .close i.fa.fa-close").addClass("fas fa-times"),C(".legal-consent-container > div").initialize(function(){""==C.trim(C(this).text())&&C(this).addClass("hidden")}),C(".hs-inline-edit .nbomfp-wrap[tabindex]").initialize(function(){C(this).removeAttr("tabindex")}),C(".blog-listing-row .content-card").initialize(function(){C(this).find("a").eq(0).is(":empty")&&C(this).remove()})});